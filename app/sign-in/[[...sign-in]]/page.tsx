  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-4 bg-canvas relative overflow-hidden">
      <div className="w-full max-w-md">
        <SkeuoCard
          variant="paper"
          titleText="Masuk ke Maguru"
          descriptionText="Selamat datang kembali! Silakan masukkan email dan kata sandi Anda."
        >
          {error && (
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            ...
            <div className="text-center pt-3 border-t border-text-faint/10 mt-4">
