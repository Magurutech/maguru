    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col h-full">
          {/* Header */}
          <div className="border-b border-beige-200/50 p-4 bg-white/50 backdrop-blur-sm flex-shrink-0">
          ...
          {/* Input Area */}
          <div className="border-t border-beige-200/50 p-4 bg-white/50 backdrop-blur-sm flex-shrink-0">
