 ...
 *
 * Header area yang menampilkan sapaan nama user, tanggal hari ini,
 * quote motivasi belajar, input pencarian, dan tombol notifikasi.
 */
...
export function DashboardHeader({ userName }: DashboardHeaderProps) {
  ...
  return (
    <section aria-label="Selamat Datang" className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-border/10">
      <div className="space-y-1 max-w-xl">
        <span className="text-[10px] font-bold text-accent-coral tracking-widest uppercase">
          LEARNING COMMAND CENTER · {getFormattedDate()}
        </span>
        ...
        <p className="text-text-secondary text-sm leading-relaxed">
          Hari ini adalah kesempatan bagus untuk mendekati target kompetensimu. AI Co-Teacher siap mendampingi.
        </p>
      </div>
