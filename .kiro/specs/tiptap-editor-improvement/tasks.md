...
### Phase 1: Critical Fixes (P0) - 5 Features
...
- [x] 1. Baca dokumentasi lesson API endpoint (PUT `/api/lessons/:id`)
- [x] 1. Review `lesson.service.ts` untuk memahami server-side version increment logic
- [x] 1. Cek struktur `LessonContent` interface di codebase

**Implementation:**

- [x] 4. Implementasi version tracking fix
...
- [x] 5. Unit Test: Test version increment logic
...
- [x] 6. API Test (Postman): Test lesson update endpoint
...
- [x] 7. E2E Test (Playwright): Test version tracking flow
...
#### Feature 2: Lesson Order Conflict Fix
...
- [x] 3. Baca dokumentasi React `beforeunload` event handling
- [x] 3. Review Tiptap editor events documentation (editor.on('update'))
- [x] 3. Cek implementasi existing dialog components di shadcn/ui

**Implementation:**

- [x] 21. Buat hook `features/cms/hooks/manage/useUnsavedChanges.ts`
...
- [x] 22. Integrasikan hook ke `LessonEditorPanel` di `ManageContent.tsx`
...
- [x] 23. Unit Test: Test useUnsavedChanges hook
  ...
  - File: `features/cms/hooks/manage/useUnsavedChanges.test.ts`
  - ✅ **14/14 tests passing**

- [x] 24. Integration: useUnsavedChanges ke ManageContent.tsx
  - **Note:** LessonEditorPanel adalah internal component di dalam ManageContent.tsx
  - Integrasikan useUnsavedChanges hook ke LessonEditorPanel
  - Tambahkan initialTitle & initialContent state untuk dirty tracking
  - Tampilkan dot indicator (•) di save button saat isDirty = true
  - Panggil resetDirty() setelah save sukses dan saat cancel
  - File: `features/cms/components/creator/manage/ManageContent.tsx`
  - Test file: `features/cms/components/creator/manage/ManageContent.test.tsx`

**Testing:**

- [x] 24.1 Unit Test: Test ManageContent integration
